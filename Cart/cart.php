            ...
            $sql="SELECT * FROM Items WHERE Item_id IN ("; 
                    ...
                    ?> 
                        <tr> 
                            ...
                            <td><input type="text" name="quantity[<?php echo $row['id_product'] ?>]" size="5" value="<?php echo $_SESSION['cart'][$row['Item_id']]['quantity'] ?>" /></td> 
                            <td><?php echo $row['price'] ?>$</td> 
                            <td><?php echo $_SESSION['cart'][$row['Item_id']]['quantity']*$row['price'] ?>$</td> 
                        </tr> 
                    <?php 
